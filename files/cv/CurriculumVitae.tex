...
\begin{document}
	...
	\begin{itemize}[topsep=0pt]
		...
		\itemsep-0.3em
		\item Morphology in neural machine translation
	...
	{\textbf{Institutional Research \& Advanced Analytics, University of Kentucky}},
	Lexington, KY\\
		\textit{Research Assistant}
		\hfill \textbf{May 2018 - August 2018}\\
		Supervisors: Nathan Jacobs, Craig Rudick
		\begin{innerlist}
			\item Designed a system that, given a student's prior performance, would
			predict their future grades course-by-course.
			\item Implemented deep LSTMs and NLP techniques (e.g., learning word embeddings
			on course descriptions) to learn student and course profiles.
			\item Designed an ordinal loss function that observed not
			just whether the grade was correct, but how close the prediction was to the real
			grade.
		\end{innerlist}
...
news articles, uses distant supervision to extract the names of American citizens who have been killed by police.
	...
	Baltimore, MD\\
		...
		\begin{innerlist}
			\item Collaborated with undergraduate and graduate students, post-doctoral researchers, and faculty to create automatic translation systems for low-resource languages under the specifications of DARPA's Low-Resource Languages for Emergent Incidents (LORELEI) program.
			\item Assisted in the creation of a lemma-based translation model between English and Uyghur.
			\item Built a morphological generator for Crimean Tatar.
			\item Tokenized Uyghur-English parallel and monolingual corpora; created histograms for each.
	...
	\hfill{\bf{August 2018 - May 2023}}\\
		Awarded in recognition and support of graduate students in NSF-supported
		disciplines who are pursuing research-based Master's and doctoral degrees
		at U.S. institutions. (\$102,000+)
	
	\halfblankline
	
	\textit{Gaines Fellow}
	\hfill{\bf{August 2016 - May 2018}}\\
		Two-year fellowship awarded in recognition of undergraduates with outstanding academic performance, demonstrated ability to conduct undergraduate research, an interest in public issues, and a desire to enhance understanding of the human condition through the humanities. Requires the completion of a juried project, a major thesis project, and a seminar in the humanities. (\$5,000)
	
	\halfblankline

	\textit{Raymond F. Betts Scholar}
	\hfill{\bf{November 2017}}\\
	...
	\hfill{\bf{March 2017}}\\
	Awarded to outstanding college sophomores and juniors intending to pursue research careers in the natural sciences, mathematics, and engineering. Awardees and honorable mentions must have demonstrated excellence in and a clear commitment to research in their undergraduate studies, as well as clear plans to pursue research in the future.
	
	\halfblankline
	
	\textit{Phi Beta Kappa}
	\hfill{\bf{March 2017}}\\
	Selective national academic honors society promoting excellence in the liberal arts and sciences. Membership is typically awarded to less than the top 10\% of a university's class. 
	
	\halfblankline
	
	\textit{National Merit Scholar}
	\hfill{\bf{May 2014}}\\
		Nationally competitive scholarship awarded to high school students with exceptional PSAT scores. (\$2,000)
	...
	Lexington, KY\\
		...
		\begin{innerlist}
			\item Promote the importance of programs within the Chellgren Center, 
			including the Office of Undergraduate Research and the Chellgren Fellowship.
			\item Organize panel discussions, workshops, and lectures on
			abstract writing, research poster design, and academic presentations.
			\item On the review committee for our Showcase of Undergraduate Scholars,
			an annual conference where University of Kentucky undergraduates present their
			research to other students and faculty. Typically features 200+ presenters across
			all disciplines.
		\end{innerlist}
	...
	Lexington, KY\\
		...
		\hfill \textbf{September 2015 - May 2016}
		\begin{innerlist}
			\item Made accessible an archival collection that highlights Lexington's architectural history---the Frankel and Curtis blueprints and papers.
	...
	\section{Languages}
	Fluent in English and French (Canadian). Rudimentary Inuktitut and Dutch.
