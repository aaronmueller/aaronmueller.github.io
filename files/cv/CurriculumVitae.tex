...
\begin{document}
	...
	\hfill Amherst, MA\\
		\textit{Research Intern}, SLANG Lab
		\hfill May -- Aug.\ 2017\\
		Advisor: Brendan O'Connor
		\begin{innerlist}
			\item Research (joint with Katherine A.\ Keith) in integrating document-level features into an entity-event extraction system.
		\end{innerlist}

	\section{Publications}

	\subsection{\textbf{Peer-reviewed Proceedings \& Articles}}
	\begin{enumerate}[leftmargin=*, topsep=0pt, itemsep=0ex, partopsep=0ex, parsep=1ex]
	...
	\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=0ex, partopsep=0ex, parsep=1ex]

	\item[] \emph{Planting Trees in Language Models: Emergent Syntactic Behaviors and Mechanisms\newline from Pre-training.}\vspace{-1ex}
	\begin{innerlist}[topsep=0pt]
	...
	\end{innerlist}
	\item[] \emph{What Generalizations do Sequence-to-sequence Models Learn from Multilingual Text? Insights from Translation and Syntactic Transformations.} Multilingual Text Processing Group, National Research Council of Canada (Ottawa, ON). Mar.\ 4, 2022.
	\item[] \emph{Syntactic Agreement in Neural Language Models: How Well and Where Do They Perform Subject-Verb Agreement?} Language \& Understanding Group, Mila -- Québec Artificial Intelligence Institute (Montréal, QC). Mar.\ 22, 2021.
	\item[] \emph{Causal Mediation Analysis for Analyzing Neural Networks.} Fairness \& Interpretability Research Talk Series, Google (New York, NY). Mar.\ 17, 2021.
	\item[] \emph{Causal Analysis of Syntactic Agreement Mechanisms in Neural Language Models.} Center for Language \& Speech Processing Seminar, Johns Hopkins University (Baltimore, MD). Feb.\ 12, 2021.
	\end{itemize}
	%\halfblankline
