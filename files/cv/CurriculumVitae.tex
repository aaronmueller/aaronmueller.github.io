...
\begin{document}
	...
	Cambridge, MA\\
		\textit{Analytics \& Machine Intelligence Research Intern}
		\hfill May - August 2019\\
		Supervisors: Roger Bock, Ilana Heintz
		\begin{innerlist}
			\item Research in improving the speed-accuracy trade-off in neural machine translation, word alignment, and entity linking.
		\end{innerlist}
	...
	\textbf{Statistical Social Language Analysis Lab}\\
		...
		\begin{innerlist}
			...
			\item Integrated entity mention and relation systems into pre-existing sentence-level model. Also integrated document-level information (e.g., noun coreferences) as features.
		\end{innerlist}
	...
	\textsc{Refereed Conference Proceedings}
	...
	\textsc{Non-Refereed and Others}
	\begin{enumerate}[resume,leftmargin=*, topsep=0pt, itemsep=-1ex, partopsep=0ex, parsep=1ex]
	\item \textbf{Aaron Mueller}, Mark Richard Lauersdorf, Kevin McGowan, and Ramakanth Kavuluru. \emph{Neural Machine Translation for Canadian French.} Undergraduate thesis, 2018.
	\end{enumerate}
	...
	Lexington, KY\\
		...
		\begin{innerlist}
			...
			an annual research conference for University of Kentucky undergraduates.
		\end{innerlist}
...
%	\end{innerlist}
	...
	%
	\begin{innerlist}
		\item Languages: Python, C$+$$+$, C, HTML, CSS, Javascript, Java, UNIX shell scripting.
		\item Machine Learning Toolkits: PyTorch (incl.\ huggingface, fairseq, sockeye), Keras, TensorFlow.
		\item Version Control: DVCS (Git, Bitbucket).
		\item Development Environments: Vim, Emacs, VSCode.
	\end{innerlist}
