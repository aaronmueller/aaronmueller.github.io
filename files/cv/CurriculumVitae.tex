...
\definecolor{accent}{HTML}{D22B2B}
...
\begin{document}
	...
	\section{Contact}
	Center for Computing and Data Sciences (CDS)
	\hfill\href{mailto:amueller@bu.edu}{\texttt{amueller@bu.edu}} \\
	Boston University
	\hfill\ttlink{https://aaronmueller.github.io}{aaronmueller.github.io}\\
	665 Commonwealth Ave., Office 806\\
	Boston, MA 02215 (USA)
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Mechanistic and causal interpretability
		\item Causality
	...
	\hfill Boston, MA\\
		\textit{Assistant Professor}, Department of Computer Science
	...
	\item Jacob Brinton, Jannik Brinkmann, Mark Crovella, \textbf{Aaron Mueller}. ``The Interlingua Hypothesis: LLMs Translate via a Latent Task-agnostic Feature Space.'' Accepted to the \emph{Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2026.
	
	\item Keren Fuentes, \textbf{Aaron Mueller}. ``Who Do Language Models Think Is Competent? A Mechanistic Analysis of Occupational Bias.'' Accepted to the \emph{Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2026.
	
	\item Kerem Sahin, Sheridan Feucht, Adam Belfki, Jannik Brinkmann, \textbf{Aaron Mueller}, David Bau, Chris Wendler. ``\titlelink{https://arxiv.org/abs/2511.05743}{In-context Learning Beyond Copying: A Training-time Analysis of Abstractive ICL}.'' Accepted to the \emph{Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2026.

	\item \textbf{Aaron Mueller}, Andrew Lee, Shruti Joshi, Ekdeep Singh Lubana, Dhanya Sridhar, Patrik Reizinger. ``\titlelink{https://arxiv.org/abs/2512.15134}{From Isolation to Entanglement: When Do Interpretability Methods Identify and Disentangle Known Concepts?}'' \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.
	
	\item John Seon Keun Yi, \textbf{Aaron Mueller}, Dokyun Lee. ``\titlelink{https://arxiv.org/abs/2604.24881}{Latent Agents: A Post-Training Procedure for Internalized Multi-Agent Debate}.'' \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.

	\item Deniz Bayazit, \textbf{Aaron Mueller}, Antoine Bosselut. ``\titlelink{https://arxiv.org/abs/2509.05291v1}{Crosscoding Through Time: Tracking Emergence \& Consolidation of Linguistic Representations Throughout LLM Pretraining}.'' \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.

	\item Tomer Ashuach, Dana Arad, \textbf{Aaron Mueller}, Martin Tutek, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2508.13650}{CRISP: Persistent Concept Unlearning via Sparse Autoencoders}.'' \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.
	
	\item Zilu Tang, Qiao Zhao, Gabriel Franco, Derry Wijaya, \textbf{Aaron Mueller}, Sebastian Schuster, Najoung Kim. ``\titlelink{https://icml.cc/virtual/2026/poster/64207}{Do Language Models Track Entities Across State Changes?}'' \emph{Proceedings of the International Conference on Machine Learning (ICML)}, 2026.

	\item Shruti Joshi, \textbf{Aaron Mueller}, David Klindt, Wieland Brendel, Patrik Reizinger, Dhanya Sridhar. ``\titlelink{https://arxiv.org/abs/2602.16698}{Causality is Key for Interpretability Claims to Generalise}.'' \emph{Proceedings of the International Conference on Machine Learning (ICML)}, 2026.
	
	\item Shengao Wang, Wenqi Wang, Zecheng Wang, Max Whitton, Michael Wakeham, Arjun Chandra, Joey Huang, Pengyue Zhu, Helen Chen, David Li, Jeffrey Li, Shawn Li, Andrew Zagula, Amy Zhao, Andrew Zhu, Sayaka Nakamura, Yuki Yamamoto, Jerry Jun Yokono, \textbf{Aaron Mueller}, Bryan A. Plummer, Kate Saenko, Venkatesh Saligrama, Boqing Gong. ``\titlelink{https://arxiv.org/abs/2512.10932}{BabyVLM-V2: Toward Developmentally Grounded Pretraining and Benchmarking of Vision Foundation Models}.'' In \emph{Proceedings of the Conference on Computer Vision and Pattern Recognition (CVPR)}, 2026.
	
	\item Ekdeep Singh Lubana, Can Rager, Sai Sumedh R. Hindupur, Valerie Costa, Greta Tuckute, Oam Patel, Sonia Krishna Murthy, Thomas Fel, Daniel Wurgaft, Eric J. Bigelow, Johnny Lin, Demba Ba, Martin Wattenberg, Fernanda Viegas, Melanie Weber, \textbf{Aaron Mueller}. ``\titlelink{https://arxiv.org/abs/2511.01836}{Priors in Time: Missing Inductive Biases for Language Model Interpretability}.'' In \emph{Proceedings of the International Conference on Learning Representations (ICLR)}, 2026.

	\item Zhengyang Shan, \textbf{Aaron Mueller}. ``\titlelink{https://arxiv.org/abs/2512.20796}{Measuring Mechanistic Independence: Can Bias Be Removed Without Erasing Demographics?}'' In \emph{Proceedings of the European Chapter of the Association for Computational Linguistics (EACL)}, 2026.
	
	\item Joe Stacey, Lisa Alazraki, Aran Ubhi, Beyza Ermis, \textbf{Aaron Mueller}, Marek Rei. ``\titlelink{https://arxiv.org/abs/2505.20209}{Improving the OOD Performance of Closed-Source LLMs on NLI Through Strategic Data Selection}.'' In \emph{Proceedings of the European Chapter of the Association for Computational Linguistics (EACL)}, 2026.
	
	\item Dana Arad, \textbf{Aaron Mueller}, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2505.20063}{SAEs Are Good for Steering -- If You Select the Right Features}.'' In \emph{Proceedings of the Annual Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2025.\label{pub:sae-steering}
	...
	\item Alina Klerings, Christian Bartelt, \textbf{Aaron Mueller}. ``\titlelink{https://aclanthology.org/2024.conll-babylm.10/}{Developmentally Plausible Multimodal Language Models Are Highly Modular}.'' In \emph{Proceedings of the BabyLM Challenge at the Conference on Computational Natural Language Learning (CoNLL)}, 2024.\label{pub:modular-babylm}
	...
	\subsection{\textbf{Invited Commentary \& Editorials}}
	\begin{enumerate}[leftmargin=*, topsep=0pt, itemsep=0.25ex, partopsep=0ex, parsep=1ex, label=I\arabic*., ref=I\arabic*]

	\item \textbf{Aaron Mueller}. ``\titlelink{https://www.nature.com/articles/d41586-026-01267-4}{Algorithm that gets ‘under the hood’ of AI models could effectively steer their responses}.'' [Commentary on Beaglehole et al. (2026), ``Toward universal steering and monitoring of AI models,'' in \emph{Science}.] In \emph{Nature News and Views}, 2026.
	...
	\begin{enumerate}[leftmargin=*, topsep=0pt, itemsep=0.25ex, partopsep=0ex, parsep=1ex, label=P\arabic*., ref=P\arabic*]
		
	\item Sankaran Vaidyanathan, David Arbour, \textbf{Aaron Mueller}, Scott Niekum, David Jensen. ``\titlelink{https://arxiv.org/abs/2606.27510}{The Curse of Multiple Mediators: Hidden Interaction Effects in Activation Patching}.'' arXiv preprint, 2026.
	
	\item Tal Haklay, Nikhil Prakash, Sana Pandey, Antonio Torralba, \textbf{Aaron Mueller}, Jacob Andreas, Tamar Rott Shaham, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2603.20101}{Pitfalls in Evaluating Interpretability Agents}.'' arXiv preprint, 2026.
	
	\item Kevin Lu, Jannik Brinkmann, Stefan Huber, \textbf{Aaron Mueller}, Yonatan Belinkov, David Bau, Chris Wendler. ``\titlelink{https://arxiv.org/abs/2602.06020}{Mechanisms of AI Protein Folding in ESMFold}.'' arXiv preprint, 2026.
...
\section{\textbf{Editor}}
	...
	\subsection{\textbf{Workshop \& Shared Task Proceedings}}

	\begin{enumerate}[leftmargin=*, topsep=0pt, itemsep=0.25ex, partopsep=0ex, parsep=1ex, label=EW\arabic*., ref=EW\arabic*]

	\item Yonatan Belinkov, \textbf{Aaron Mueller}, Najoung Kim, Hosein Mohebbi, Hanjie Chen, Dana Arad, Gabriele Sarti. ``\titlelink{https://aclanthology.org/volumes/2025.blackboxnlp-1/}{Proceedings of the 8th BlackboxNLP Workshop: Analyzing and Interpreting Neural Networks for NLP}.'' 2025.
	
	\item Lucas Charpentier, Leshem Choshen, Ryan Cotterell, Mustafa Omer Gul, Michael Y. Hu, Jing Liu, Jaap Jumelet, Tal Linzen, \textbf{Aaron Mueller}, Candace Ross, Raj Sanjay Shah, Alex Warstadt, Ethan Gotlieb Wilcox, Adina Williams. ``\titlelink{https://aclanthology.org/volumes/2025.babylm-main/}{Proceedings of the First BabyLM Workshop}.'' 2025.
	...
	\emph{Does Interpretability Need to Be Mechanistic?} [Joint talk with Tiago Pimentel.]\\
	Keynote at the 2nd Big Picture Workshop, co-located with the 64th Annual Meeting of the Association
	for Computational Linguistics (ACL; San Diego, CA). Jul.\ 4, 2026.

	\halfblankline
	
	\emph{Interpretability as an Engineering Tool for NLP.}\\
	Sheffield NLP Seminar Series, University of Sheffield (Sheffield, UK; virtual). Jun.\ 22, 2026.
	
	\halfblankline
	
	\emph{Evaluating Methods for Locating and Controlling Concepts in Language Models.}\\
	10th Annual Center for Human-Compatible AI (CHAI) Workshop (Pacific Grove, CA). Jun.\ 7, 2026.
	
	\halfblankline

	\emph{Locating and Steering Concepts in Language Models: A Causal Audit.}\\
	Language and Technology Lab (LTL), University of Cambridge (Cambridge, UK; virtual). May 7, 2026.

	\halfblankline
	
	\emph{Understanding Incremental Processing in LLMs with Temporal Feature Analysis.}\\
	Text-as-Data Seminar Series, New York University (New York, NY). Feb.\ 5, 2026.
	
	\halfblankline
	
	\emph{Building and Understanding Human-scale Language Models.}\\
	Natural Language \& Information Processing (NLIP) Seminar Series, University of Cambridge (Cambridge, UK; virtual). Dec.\ 5, 2025.

	\halfblankline

	\emph{Neurons, Directions, and Hulls: Rethinking the Geometry of Concepts in Large Language Models.}\\
	ML@FI Seminar Series, Flatiron Institute (New York, NY). Nov.\ 21, 2025.

	\halfblankline

	\emph{Time- and Context-aware Interpretability.}\\
...
%	\halfblankline
	...
	Aaron Mueller (PI). \emph{Beyond Binary Variables: Defining, Locating, and Editing}\hfill 2025--2028\\
	\emph{Multi-dimensional Features in Large Language Models}. National Science\\Foundation (award 2530728) and United States--Israel Binational Science\\
	Foundation (PI: Yonatan Belinkov). \$758,652.00 (\$471,529.00 to BU).

	\halfblankline

	Aaron Mueller (PI). \emph{Interpretability Beyond Human Concepts.} Coefficient Giving.\hfill 2025--2027\\
	\$373,219.00.
	...
	``\titlelink{https://www.technologyreview.com/2025/08/01/1120924/forcing-llms-to-be-evil-during-training-can-make-them-nicer-in-the-long-run/}{Forcing LLMs to be evil during training can make them nicer in the long run}.'' \emph{MIT Technology Review}, Aug.\ 2025.
	
	\halfblankline
	
	``\titlelink{https://spectrum.ieee.org/small-language-models-apple-microsoft}{Apple, Microsoft Shrink AI Models to Improve Them}.'' \emph{IEEE Spectrum}, Jun.\ 2024.
	
	\halfblankline

	``\titlelink{https://www.nytimes.com/2023/05/30/science/ai-chatbots-language-learning-models.html}{The Race to Make AI Smaller (and Smarter)}.'' \emph{The New York Times}, May 2023.

	\section{Mentoring}
	\subsection{\textbf{Ph.D.\ advising}}
	\begin{innerlist}
	\item Zhengyang Shan (BU). Research on developing interpretability frameworks\hfill 2024--Pres.\\
	      for understanding and mitigating spurious correlations in LLMs.
	\item Micah Benson (BU). Research on LLMs for social good.\hfill 2025--Pres.
	\item Themistoklis Nikas (BU). Research on meta-cognitive capabilities in LLMs.\hfill 2025--Pres.
	\item Divya Appapogu (BU). Research on high-dimensional concept discovery.\hfill 2025--Pres.
	\item Nishkal Hundia (BU). Joint with Naomi Saphra. Research on long-context\hfill 2026--Pres.\\reasoning.
	\item Vijay Murari Tiyyala (BU). Research on improving mixture-of-experts systems.\hfill 2026--Pres.
	\end{innerlist}
	...
	Resulted in a publication at EMNLP [\ref{pub:sae-steering}].
	...
	\begin{innerlist}
	\item Hilton Raj (BU). Research on machine unlearning.\hfill 2026--Pres.
	\item Angelina Sun (BU). Research on baselines for machine unlearning.\hfill 2026--Pres.
	\item Jigar Milanbhai Kanakhara (BU). Research on how LLMs learn to be\hfill 2026--Pres.\\ sycophantic.
	\item Kerem Şahin (Northeastern). Joint with Chris Wendler. Research on the\hfill 2025--2026\\
	      training dynamics of induction.
	...
	\begin{innerlist}
	\item Jay Patel (BU). Research on emotion representations in LLMs.\hfill 2026--Pres.
	\item Jacob Brinton (BU). Joint with Mark Crovella. Research on mechanistically\hfill 2025--2026\\understanding
	      LLMs' machine translation performance.
	\item Keren Fuentes (Independent). Research on how LLMs represent user\hfill 2025--2026\\information.
	\item Edward Sun (UCLA). SPAR mentee. Research on interpretable fine-tuning\hfill 2026--Pres.\\methods.
	...
	\subsection{\textbf{BU qualifying exam committees}}
	\begin{innerlist}
	\item Sahana Kowshik (Data Science)\hfill 2026
	\item Yi Liu (Computer Science)\hfill 2026
	\item Gabriel Franco (Computer Science)\hfill 2025
	\end{innerlist}
	...
	{\textbf{Boston University}}\\
	\textit{Instructor}, Advanced Natural Language Processing \hfill Fall 2026\\
	\textit{Instructor}, Introduction to Natural Language Processing \hfill Spring 2026\\
	% \halfblankline
	\textit{Instructor}, Interpretable Machine Learning \hfill Fall 2025

	\halfblankline

	{\textbf{Technion -- Israel Institute of Technology}}\\
	\textit{Guest Lecture}, Introduction to Transformers \hfill Spring 2025\\
	\textit{Instructor: Yonatan Belinkov}

	\halfblankline
	
	{\textbf{Massachusetts Institute of Technology}}\\
	\textit{Guest Lecture}, Quantitative Methods for NLP \hfill Fall 2024\\
	\textit{Instructor}: Jacob Andreas

	\halfblankline

	{\textbf{New York University}}\\
	\textit{Guest Lecture}, Computational Linguistics \& Cognitive Science \hfill Spring 2023\\
	\textit{Instructor}: Tal Linzen

	\halfblankline

	{\textbf{Johns Hopkins University}}\\
	\textit{Teaching Assistant}, Machine Learning: AI System Design \& Development \hfill Spring 2020\\
	...
	\item \titlelink{https://blackboxnlp.github.io}{BlackboxNLP 2026} (Co-located with EMNLP 2026)
	\item \titlelink{https://babylm.github.io}{The 2026 BabyLM Workshop} (Co-located with EMNLP 2026)
	\item \titlelink{https://nemiconf.github.io/summer26/}{The 3rd New England Mechanistic Interpretability Workshop} (NEMI 2026)
	\item \titlelink{https://blackboxnlp.github.io}{BlackboxNLP 2025} (Co-located with EMNLP 2025)
	...
	\subsection{\textbf{Grant panels}}
	\begin{innerlist}[itemsep=0pt]
	\item Advisory Panel, U.S.\ National Science Foundation (NSF) (2026)
	\end{innerlist}
	...
	\begin{innerlist}[itemsep=0pt]
	\item NAACL 2027 (Publicity Chair)
	...
	\begin{innerlist}[itemsep=0pt]
	\item EMNLP 2026 (Senior Area Chair for \emph{Interpretability and Analysis of Models for NLP})
	\item ACL 2026 (Area Chair for \emph{Interpretability and Analysis of Models for NLP})
	\item ICLR 2026 (Area Chair)
	\item EACL 2026 (Area Chair for \emph{Interpretability and Analysis of Models for NLP}. \textbf{\textcolor{accent}{Outstanding Area Chair Award.}})
	...
	\subsection{\textbf{Ad hoc journal reviewing}}
	\begin{innerlist}[itemsep=0pt]
	\item Journal of Memory and Language (2025, 2024)
	\item Transactions of the Association for Computational Linguistics (2025)
	\item Computational Linguistics (2024)
	\end{innerlist}

	\halfblankline

	\subsection{\textbf{Ad hoc grant reviewing}}
	\begin{innerlist}[itemsep=0pt]
	\item Israel Science Foundation (2025)
	\end{innerlist}
	...
	\begin{innerlist}
	\item ICML (2026 [\textbf{\textcolor{accent}{Gold Reviewer Award}}], 2025)
	\item ICLR (2025)
	\item NAACL (2024, 2021)
	\item ACL (2024, 2023, 2022, 2020)
	\item COLM (2024)
	\item NeurIPS (2024 [\textbf{\textcolor{accent}{Top Reviewer Award}}])
	\item EACL (2024)
	\item FAccT (2024)
	...
	\begin{innerlist}
		...
		\item Machine Learning Toolkits: PyTorch (incl.\ fairseq, sockeye), HuggingFace, vLLM, NLTK, Scikit-learn, numpy
	...
	\begin{innerlist}
		\item Linguistic tools: Praat, AntConc, QGIS, Audacity
		\item Annotation/survey tools: Prolific, Amazon Mechanical Turk, Qualtrics
	\end{innerlist}
