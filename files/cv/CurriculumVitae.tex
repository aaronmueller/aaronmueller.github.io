...
\begin{document}
	...
	\item Zhengyang Shan, \textbf{Aaron Mueller}. ``\titlelink{https://arxiv.org/abs/2512.20796}{Measuring Mechanistic Independence: Can Bias Be Removed Without Erasing Demographics?}'' To appear in \emph{Proceedings of the European Chapter of the Association for Computational Linguistics (EACL)}, 2026.
	
	\item Joe Stacey, Lisa Alazraki, Aran Ubhi, Beyza Ermis, \textbf{Aaron Mueller}, Marek Rei. ``\titlelink{https://arxiv.org/abs/2505.20209}{Improving the OOD Performance of Closed-Source LLMs on NLI Through Strategic Data Selection}.'' To appear in \emph{Proceedings of the European Chapter of the Association for Computational Linguistics (EACL)}, 2026.
	...
	\item \textbf{Aaron Mueller}, Andrew Lee, Shruti Joshi, Ekdeep Singh Lubana, Dhanya Sridhar, Patrik Reizinger. ``\titlelink{https://arxiv.org/abs/2512.15134}{From Isolation to Entanglement: When Do Interpretability Methods Identify and Disentangle Known Concepts?}'' arXiv preprint, 2025.
	...
	\item Deniz Bayazit, \textbf{Aaron Mueller}, Antoine Bosselut. ``\titlelink{https://arxiv.org/abs/2509.05291v1}{Crosscoding Through Time: Tracking Emergence \& Consolidation of Linguistic Representations Throughout LLM Pretraining}.'' arXiv preprint, 2025.

	\item Tomer Ashuach, Dana Arad, \textbf{Aaron Mueller}, Martin Tutek, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2508.13650}{CRISP: Persistent Concept Unlearning via Sparse Autoencoders}.'' arXiv preprint, 2025.
...
%	\halfblankline
	...
	\item \item \titlelink{https://blackboxnlp.github.io}{BlackboxNLP 2026} (Co-located with EMNLP 2026)
