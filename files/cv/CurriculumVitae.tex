...
\begin{document}
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Social media analysis (sociolinguistics)
	...
	\begin{outerlist}[topsep=0pt]
		...
		\item[] \emph{Advisors}: Ramakanth Kavuluru, Mark Richard Lauersdorf.
	\end{outerlist}
	...
	\textbf{Analytics \& Machine Intelligence}\\
		\textit{Speech, Language, \& Multimedia Research Intern}
		\hfill May - August 2019\\
		Supervisors: Roger Bock, Ilana Heintz
		\begin{innerlist}
			\item Research in neural machine translation, word alignment, and entity linking.
			\item Funded by DARPA's Active Interpretation of Disparate Alternatives (AIDA) program.
		\end{innerlist}
	...
	\textbf{Center for Language \& Speech Processing}\\
		\textit{Research Assistant (Natural Language Processing)}%
		\hfill May - August 2016\\
		Supervisor: David Yarowsky
		\begin{innerlist}
			\item Collaborated with graduate students and faculty to create statistical machine translation systems for low-resource languages.
	...
	\hfill 2014 - 2018\\
		Awarded to University of Kentucky students who have earned National Merit scholarships. (\$80,000+)
	...
	\item Arya D. McCarthy, Winston Wu, \textbf{Aaron Mueller}, Bill Watson, and David Yarowsky. \emph{Modeling Color Terminology Across Thousands of Languages.} To appear at Empirical Methods in Natural Language Processing (EMNLP), 2019.

	\item Marten van Schijndel, \textbf{Aaron Mueller}, and Tal Linzen. \emph{Quantity Doesn't Buy Quality Syntax with Neural Language Models.} To appear at Empirical Methods in Natural Language Processing (EMNLP), 2019.
	...
	\textbf{Aaron Mueller}. \emph{Québec French and Language Technology.} 2018 Betts \& Rowland
	Scholar Awards Ceremony, Lexington, KY, April 4, 2018.

	\halfblankline

	\textbf{Aaron Mueller}, Katherine Keith, Abram Handler, Su Lin Blodgett, and Brendan O'Connor. \emph{The Identification of Civilians Killed by Police with Supervised Entity-Event Extraction.} 2017 UMass Amherst Research Experience for Undergraduates (REU) Showcase, Amherst, MA, August 9, 2017.

	\halfblankline

	\textbf{Aaron Mueller}, Raphael Finkel, and Hilaria Cruz. \emph{Documenting and Promoting the Chatino Language and Orthography.} Juried Presentation in Satisfaction of the Requirements of the Gaines Fellowship, Lexington, KY, February 21, 2017.
	
	\halfblankline

	\textbf{Aaron Mueller}, Huda Khayrallah, Winston Wu, and David Yarowsky. \emph{A Lemma-Based Approach for English-Uyghur Statistical Machine Translation.} 9th Annual Conference of the Illinois Language and Linguistics Society (ILLS9), Urbana, IL, March 31--April 1, 2017.
	
	\halfblankline

	\textbf{Aaron Mueller} and Mark Richard Lauersdorf. \emph{Lexical and Semantic Shifts in the Linguistic Construction of Social Gender: A Corpus-Based Analysis of Written U.S. English.} Poster.
	9th Annual Toronto Undergraduate Linguistics Conference (TULCON9), Toronto, ON, March 4--6, 2016.
	...
	\hfill January - May 2020
	\begin{innerlist}
		\item Machine Learning: AI System Design \& Development, Mathias Unberath. Spring 2020.
	\end{innerlist}
	...
	%
	\begin{innerlist}
		\item Languages: Python, C, C$+$$+$, Java, HTML, CSS, Javascript, \Matlab, R, UNIX shell scripting.
	...
	\section{Languages}
	Fluent in English and French (Canadian). Rudimentary Inuktitut. Experience
	with Chatino and Uyghur through research.
