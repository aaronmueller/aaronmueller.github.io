...
\begin{document}
	...
	\subsection{\textbf{Proceedings Articles}}
	...
	\subsection{\textbf{Other Articles and Dissertations}}
...
%	\hfill 2014
	...
	\begin{innerlist}
	\item Aruna Sankaranarayanan (MIT). Joint with Dylan Hadfield-Menell. Research on \hfill 2023--Present\\
	...
	\begin{innerlist}
	\item Tal Haklay (Technion). Research on mechanistically understanding\hfill 2024--Present\\gender bias in language models.
...
%	\end{innerlist}
	...
	\item \titlelink{https://blackboxnlp.github.io}{BlackboxNLP 2024}
	\item \titlelink{https://babylm.github.io}{The BabyLM Challenge 2024}
	\item \titlelink{https://babylm.github.io/archive_2023.html}{The BabyLM Challenge 2023}
	\item \titlelink{https://github.com/inverse-scaling/prize}{The Inverse Scaling Prize} (2022)
	\end{innerlist}

	\halfblankline

	\subsection{Conference Chairing}:
	\begin{innerlist}[itemsep=0pt]
	\item NAACL 2025 (Area Chair for \emph{Interpretability and Analysis of Models for NLP})
	\item EMNLP 2024 (Area Chair for \emph{Interpretability and Analysis of Models for NLP})
	\end{innerlist}

	\halfblankline

	\subsection{Ad-hoc Journal Reviewing}:
	\begin{innerlist}[itemsep=0pt]
