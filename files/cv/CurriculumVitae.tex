...
\begin{document}
	...
	\hfill May 2020
	\item[] GPA: 3.9/4.0
	\item[] \textit{Thesis title}: Emergent Syntactic Behaviors and Mechanisms in Neural Language Models
	...
	\item Michael Hanna*, \textbf{Aaron Mueller}*. ``\titlelink{https://arxiv.org/abs/2412.05353}{Incremental Sentence Processing Mechanisms in Autoregressive Transformer Language Models}.'' To appear in \emph{Annual Conference of the Nations of the Americas Chapter of the Association for Computational Linguistics (NAACL)}, 2025. [*Equal contribution]
	
	\item Jannik Brinkmann, Chris Wendler, Christian Bartelt, \textbf{Aaron Mueller}. ``\titlelink{https://arxiv.org/abs/2501.06346}{Large Language Models Share Representations of Latent Grammatical Concepts Across Typologically Diverse Languages}.'' To appear in \emph{Annual Conference of the Nations of the Americas Chapter of the Association for Computational Linguistics (NAACL)}, 2025.
	
	\item Juan Diego Rodriguez, \textbf{Aaron Mueller}, Kanishka Misra. ``\titlelink{https://arxiv.org/abs/2410.22590v1}{Characterizing the Role of Similarity in the Property Inferences of Language Models}.'' To appear in \emph{Annual Conference of the Nations of the Americas Chapter of the Association for Computational Linguistics (NAACL)}, 2025.\label{pub:property-inferences}
	
	\item Samuel Marks, Can Rager, Eric J. Michaud, Yonatan Belinkov, David Bau, \textbf{Aaron Mueller}. ``\titlelink{https://arxiv.org/abs/2403.19647}{Sparse Feature Circuits: Discovering and Editing Interpretable Causal Graphs in Language Models}.'' To appear in \emph{International Conference on Learning Representations (ICLR)}, 2025.\label{pub:feature-circuits}

	\item Jaden Fiotto-Kaufman, Alexander R. Loftus, Eric Todd, Jannik Brinkmann, Caden Juang, Koyena Pal, Can Rager, \textbf{Aaron Mueller}, Samuel Marks, Arnab Sen Sharma, Francesca Lucchetti, Michael Ripa, Adam Belfki, Nikhil Prakash, Sumeet Multani, Carla Brodley, Arjun Guha, Jonathan Bell, Byron Wallace, David Bau. ``\titlelink{https://arxiv.org/abs/2407.14561}{NNsight and NDIF: Democratizing Access to Foundation Model Internals}.'' To appear in \emph{International Conference on Learning Representations (ICLR)}, 2025.

	\item Yaniv Nikankin, Anja Reusch, \textbf{Aaron Mueller}, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2410.21272}{Arithmetic Without Algorithms: Language Models Solve Math With a Bag of Heuristics}.'' To appear in \emph{International Conference on Learning Representations (ICLR)}, 2025.\label{pub:math-boh}
...
%	\hfill 2014
	...
	\section{Mentoring}
	\subsection{\textbf{Ph.D.\ students}}
	\begin{innerlist}
	\item Aruna Sankaranarayanan (MIT). Joint with Dylan Hadfield-Menell. Research \hfill 2023--2025\\
		  on natural and artificial grammar learning in language models.
	\item Juan Diego Rodriguez (UT Austin). Joint with Kanishka Misra. Research\hfill 2023--2024\\
		  in how concepts are organized in language models.
	\item Eric Todd (Northeastern). Joint with David Bau. Research on how\hfill 2023--2024\\functions are
	...
	\begin{innerlist}
	\item Tal Haklay (Technion). Research on mechanistically understanding\hfill 2024--2025\\gender bias in language models.
	...
	\begin{innerlist}
		\item Quantitative Methods for NLP \hfill Fall 2024
	\end{innerlist}
...
%	\end{innerlist}
	...
	\item Journal of Memory and Language (2024)
	\end{innerlist}
