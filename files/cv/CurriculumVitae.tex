...
\begin{document}
	\makeheading{\huge{Aaron M.\ Mueller}}
	\\

	\section{Contact}
	Center for Language \& Speech Processing
	\hfill\href{mailto:amueller@jhu.edu}{\texttt{amueller@jhu.edu}} \\
	Johns Hopkins University
	\hfill\ttlink{https://aaronmueller.github.io}{aaronmueller.github.io}\\
	Hackerman 319, 3400 N. Charles St.
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Robust generalization, interpretability, evaluation
	...
	\hfill Menlo Park, CA\\
		...
		\begin{innerlist}
			...
			\item Resulted in improved F\textsubscript{1} on multiple QA and classification datasets using far fewer parameters than state-of-the-art models. Also resulted in a submission to ACL (under review) [\ref{pub:metalearn}].
		\end{innerlist}
	...
	\item \textbf{Aaron Mueller}, Tal Linzen. ``\titlelink{https://arxiv.org/abs/2305.19905}{How to Plant Trees in Language Models: Data and Architectural Effects on the Emergence of Syntactic Inductive Biases}.'' In \emph{Association for Computational Linguistics (ACL)}, 2023.
	...
	\item Koustuv Sinha, Jon Gauthier, \textbf{Aaron Mueller}, Kanishka Misra, Keren Fuentes, Roger Levy, Adina Williams. ``\titlelink{https://arxiv.org/abs/2212.08979}{Language Model Acceptability Judgements Are Not Always Robust to Context}.'' In \emph{Association for Computational Linguistics (ACL)}, 2023. \textbf{\emph{Outstanding Paper Award.}}

	\item Julian Michael, Ari Holtzman, Alicia Parrish, \textbf{Aaron Mueller}, Alex Wang, Angelica Chen, Divyam Madaan, Nikita Nangia, Richard Yuanzhe Pang, Jason Phang, Samuel R.\ Bowman. ``\titlelink{https://arxiv.org/abs/2208.12852}{What Do NLP Researchers Believe? Results of the NLP Community Metasurvey}.'' In \emph{Association for Computational Linguistics (ACL)}, 2023.
	...
	\item Ian R. McKenzie, Alexander Lyzhov, Michael Martin Pieler, Alicia Parrish, \textbf{Aaron Mueller}, Ameya Prabhu, Euan McLean, Xudong Shen, Joe Cavanagh, Andrew George Gritsevskiy, Derik Kauffman, Aaron T. Kirtland, Zhengping Zhou, Yuhui Zhang, Sicong Huang, Daniel Wurgaft, Max Weiss, Alexis Ross, Gabriel Recchia, Alisa Liu, Jiacheng Liu, Tom Tseng, Tomasz Korbak, Najoung Kim, Samuel R. Bowman, Ethan Perez. ``\titlelink{https://arxiv.org/abs/2306.09479}{Inverse Scaling: When Bigger Isn't Better}.'' In submission to \emph{Transactions on Machine Learning Research (TMLR)}, 2023.
	
	\item \textbf{Aaron Mueller}, Tal Linzen. ``Does In-context Learning Impart Robust Reasoning? A Case Study in Syntactic Generalization.'' In submission to \emph{Empirical Methods in Natural Language Processing (EMNLP)}, 2023.
	
	\item Alex Warstadt, Leshem Choshen, \textbf{Aaron Mueller}, Adina Williams, Ethan Wilcox, Chengxu Zhuang. ``\titlelink{https://arxiv.org/abs/2301.11796}{The BabyLM Challenge: Sample-efficient Pretraining on a Developmentally Plausible Corpus}.'' Call for papers for the shared task of the \emph{Conference on Computational Natural Language Learning (CoNLL)}, 2023.
...
%	\halfblankline
	...
	\hfill 2023--2025\\
		Two-year post-doctoral fellowship. Supports research joint with an Israeli university and an American university. (\$126,000)
...
%	\hfill 2014
	...
	\begin{innerlist}
	\item[\textbullet] Dan Pechi (New York University). In progress. Work on imparting inductive\hfill 2023\\biases to language models.
	\item[\textbullet] Swapnil Sharma (New York University). In progress. Work on evaluating\hfill 2022--2023\\summarization models.
...
%	\end{innerlist}
	...
	\item[\textbullet] \titlelink{https://babylm.github.io}{The BabyLM Shared Task} (CoNLL 2023)
	\item[\textbullet] \titlelink{https://github.com/inverse-scaling/prize}{The Inverse Scaling Prize} (2022)
	\end{innerlist}
	...
	\begin{innerlist}
	\item[\textbullet] ACL Rolling Review (Oct.\ 2021 -- present; monthly)
	\item[\textbullet] ACL (2022, 2020)
	\item[\textbullet] EMNLP (2022, 2019)
	\item[\textbullet] CoNLL (2022)
	\item[\textbullet] TACL (2022)
	\item[\textbullet] NAACL (2021)
	\item[\textbullet] CSCW (2021)
	\item[\textbullet] COLING (2020)
	\end{innerlist}
	\halfblankline
	...
	\section{Languages}
	English (native language), French (B2, Canadian).\newline Experience in German and Finnish through research.
