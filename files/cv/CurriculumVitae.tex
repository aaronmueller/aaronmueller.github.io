...
\begin{document}
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Mechanistic interpretability and evaluation
	...
	\item Alex Warstadt, Leshem Choshen, \textbf{Aaron Mueller}, Adina Williams, Ethan Wilcox, Chengxu Zhuang. ``\titlelink{https://arxiv.org/abs/2301.11796}{Findings of the BabyLM Challenge: Sample-efficient Pretraining on a Developmentally Plausible Corpus}.'' To appear at the \emph{Conference on Computational Natural Language Learning (CoNLL)}, 2023.
	
	\item Eric Todd, Millicent L. Li, Arnab Sen Sharma, \textbf{Aaron Mueller}, Byron C. Wallace, David Bau. ``\titlelink{https://arxiv.org/abs/2310.15213}{Function Vectors in Large Language Models}.'' In submission to \emph{International Conference on Learning Representations (ICLR)}, 2024.\label{pub:function-vectors}
...
%	\hfill 2014
	...
	\begin{innerlist}
	\item Aruna Sankaranarayanan (Massachusetts Institute of Technology). \hfill 2023--Present\\Joint with Forrest Davis. Research on
		natural and artificial grammar\\learning in language models.
	\item Eric W.\ Todd (Northeastern University). Joint with David Bau.\hfill 2023--Present\\Research on how functions are
		represented in neural language models.\\Work in submission to ICLR [\ref{pub:function-vectors}].
	\end{innerlist}
	...
	\begin{innerlist}
	\item Dan Pechi (New York University). Research on imparting inductive \hfill2023--Present\\biases to language models.
	\item Swapnil Sharma (New York University). Research on evaluating\hfill 2022--Present\\summarization models.
	\item Yash Kumar Lal (Johns Hopkins). Resulted in a workshop publication [\ref{pub:sent-level}].\hfill 2018--2019
	\end{innerlist}
	...
	\begin{innerlist}
	\item Yu Xia (New York University). Resulted in a publication at CoNLL [\ref{pub:causal-multiling}].\hfill 2021--2022
...
%	\end{innerlist}
	...
	\item \titlelink{https://babylm.github.io}{The BabyLM Shared Task} (CoNLL 2023)
