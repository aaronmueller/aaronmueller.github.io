...
\begin{document}
	...
	\item[] \textit{Committee}: Tal Linzen, Mark Dredze, David Yarowsky, Yonatan Belinkov\\
	\end{outerlist}
	...
	\item Dana Arad, \textbf{Aaron Mueller}, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2505.20063}{SAEs Are Good for Steering -- If You Select the Right Features}.'' In \emph{Proceedings of the Annual Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2025.
...
%	\halfblankline
	...
	\begin{innerlist}
		...
		\item Machine Learning Toolkits: PyTorch (incl.\ fairseq, sockeye), HuggingFace, NLTK, Scikit-learn, numpy
		\item Version Control: DVCS (Git, Bitbucket)
	\end{innerlist}
	
	\halfblankline
	
	\subsection{\textbf{Linguistic Tools}}
	\begin{innerlist}
