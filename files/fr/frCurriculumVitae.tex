...
\begin{document}
	...
	\hfill Mai 2020
	\item[] GPA: 3.9/4.0.
	\item[] \textit{Directeurs de thèse}: Mark Dredze, David Yarowsky.\\
	\end{outerlist}
...
%	\end{innerlist}
	...
	%
	\begin{innerlist}
		\item Langages (expert): Python
		\item Langages (compétent): C$+$$+$, HTML, CSS, Javascript, Bash.
	...
	\section{Langues}
	Français (B2, canadien), anglais (langue maternelle). Expérience en allemand et finlandais par la recherche.
