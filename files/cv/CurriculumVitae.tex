...
\begin{document}
	...
	\item Alex Warstadt*, \textbf{Aaron Mueller}*, Leshem Choshen, Adina Williams, Ethan Wilcox, Chengxu Zhuang. ``\titlelink{https://arxiv.org/abs/2301.11796}{Findings of the BabyLM Challenge: Sample-efficient Pretraining on Developmentally Plausible Corpora}.'' Shared task proceedings in \emph{Conference on Computational Natural Language Learning (CoNLL)}, 2023. [*Equal contribution]
