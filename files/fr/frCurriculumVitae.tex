...
\begin{document}
	...
	\begin{enumerate}[leftmargin=*, topsep=0pt, itemsep=-1ex, partopsep=0ex, parsep=1ex]
		...
		\item Arya D. McCarthy, Winston Wu, \textbf{Aaron Mueller}, Bill Watson et David Yarowsky. \emph{Modeling Color Terminology Across Thousands of Languages.} À apparaître aux Empirical Methods in Natural Language Processing (EMNLP), 2019.

	\item Marten van Schijndel, \textbf{Aaron Mueller} et Tal Linzen. \emph{Quantity Doesn't Buy Quality Syntax with Neural Language Models.} À apparaître aux Empirical Methods in Natural Language Processing (EMNLP), 2019.
