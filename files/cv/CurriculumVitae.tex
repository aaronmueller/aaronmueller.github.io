...
\begin{document}
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Syntax, pragmatics, and sociolinguistics
	...
	Cambridge, MA\\
		...
		Supervisor: Roger Bock
		\begin{innerlist}
			\item Future intern working with information extraction systems.
		\end{innerlist}
	...
	\textbf{Center for Language \& Speech Processing}\\
		...
		\begin{innerlist}
			...
			\item Implemented a lemma-based English-Uyghur translation model.
	...
	Mueller, Aaron. Québec French and Language Technology. \emph{2018 Betts \& Rowland
	...
	Mueller, Aaron and Lauersdorf, Mark R. Lexical and Semantic Shifts in the Linguistic Construction of Social Gender: A Corpus-Based Analysis of Written U.S. English. Poster.
