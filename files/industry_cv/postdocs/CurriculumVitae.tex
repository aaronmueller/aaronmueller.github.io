...
\begin{document}
	...
	\begin{itemize}[topsep=0pt]
		...
		\item Interpretability and robust generalization
		\item Computational psycholinguistics (syntax and morphology)
	\end{itemize}
	\section{Education}
	...
	\item Alexandra DeLucia, Shijie Wu, \textbf{Aaron Mueller}, Carlos Aguirre, Mark Dredze, Philip Resnik. ``\textsc{Bernice}: A Multilingual Pre-trained Encoder for Twitter.'' To appear in \emph{Proceedings of the Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2022.
	...
	\item Julian Michael, Ari Holtzman, Alicia Parrish, \textbf{Aaron Mueller}, Alex Wang, Angelica Chen, Divyam Madaan, Nikita Nangia, Richard Yuanzhe Pang, Jason Phang, Samuel R.\ Bowman. ``What do NLP Researchers Believe? Results of the NLP Community Metasurvey.'' \emph{arXiv preprint}, in submission to \emph{Transactions of the Association for Computational Linguistics (TACL)}, 2022.
...
%	\halfblankline
	...
	\hfill 2014 - 2018\\
		Awarded to University of Kentucky undergraduates who have earned National Merit semifinalist standing or better. (\$80,000+)
...
%	\hfill 2014
	...
	Yash Kumar Lal (JHU. Now Ph.D.\ student at Stony Brook University.)
	\hfill 2018--2019

	\halfblankline
	
	\textbf{Undergraduate researchers}\\
	Yu Xia (NYU. Now Master's student at New York University.)
	\hfill 2021--2022

	Matthew Finlayson (Harvard. Now predoctoral researcher at Allen Institute for AI.)
	\hfill 2020--2021
...
%	\end{innerlist}
	...
	%
	\begin{innerlist}
		\item Languages (expert): Python, C$++$, HTML, CSS, Javascript, Bash
	...
	\emph{Primary Reviewer}: ACL (2022, 2020), EMNLP (2022, 2019), NAACL (2021), CoNLL (2022), \newline COLING (2020).
	
	\emph{Secondary Reviewer}: TACL (2022).
