...
\begin{document}
	...
	\item \textbf{Aaron Mueller}, Andrew Lee, Shruti Joshi, Ekdeep Singh Lubana, Dhanya Sridhar, Patrik Reizinger. ``\titlelink{https://arxiv.org/abs/2512.15134}{From Isolation to Entanglement: When Do Interpretability Methods Identify and Disentangle Known Concepts?}'' To appear in \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.
	
	\item John Seon Keun Yi, \textbf{Aaron Mueller}, Dokyun Lee. ``\titlelink{https://arxiv.org/abs/2604.24881}{Latent Agents: A Post-Training Procedure for Internalized Multi-Agent Debate}.'' To appear in \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.

	\item Deniz Bayazit, \textbf{Aaron Mueller}, Antoine Bosselut. ``\titlelink{https://arxiv.org/abs/2509.05291v1}{Crosscoding Through Time: Tracking Emergence \& Consolidation of Linguistic Representations Throughout LLM Pretraining}.'' To appear in \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.

	\item Tomer Ashuach, Dana Arad, \textbf{Aaron Mueller}, Martin Tutek, Yonatan Belinkov. ``\titlelink{https://arxiv.org/abs/2508.13650}{CRISP: Persistent Concept Unlearning via Sparse Autoencoders}.'' To appear in \emph{Proceedings of the Association for Computational Linguistics (ACL)}, 2026.
	
	\item Zilu Tang, Qiao Zhao, Gabriel Franco, Derry Wijaya, \textbf{Aaron Mueller}, Sebastian Schuster, Najoung Kim. ``\titlelink{https://icml.cc/virtual/2026/poster/64207}{Do Language Models Track Entities Across State Changes?}'' To appear in \emph{Proceedings of the International Conference on Machine Learning (ICML)}, 2026.

	\item Shruti Joshi, \textbf{Aaron Mueller}, David Klindt, Wieland Brendel, Patrik Reizinger, Dhanya Sridhar. ``\titlelink{https://arxiv.org/abs/2602.16698}{Causality is Key for Interpretability Claims to Generalise}.'' To appear in \emph{Proceedings of the International Conference on Machine Learning (ICML)}, 2026.
	...
	\item Kerem Sahin, Sheridan Feucht, Adam Belfki, Jannik Brinkmann, \textbf{Aaron Mueller}, David Bau, Chris Wendler. ``\titlelink{https://arxiv.org/abs/2511.05743}{In-context Learning Without Copying}.'' arXiv preprint, 2025.
...
%	\halfblankline
	...
	Aaron Mueller (PI) and Yonatan Belinkov (PI). \emph{Beyond Binary Variables: Defining,}\hfill 2025--2028\\
	\emph{Locating, and Editing Multi-dimensional Features in Large Language Models}.\\National Science Foundation (award 2530728) and United States--Israel Binational\\Science
	Foundation. \$758,652.00 (\$471,529.00 to BU).
