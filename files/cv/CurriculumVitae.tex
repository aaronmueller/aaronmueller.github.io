...
\begin{document}
	...
	\itemsep-0.3em
	\item[] Ph.D. student, Computer Science (Whiting School of Engineering).
	...
	\halfblankline
		...
		\begin{innerlist}
			\item Explored the manner in which societal perceptions and opinions of gender and LGBT communities are expressed linguistically.
			\item Applied corpus-based statistical methods to the analysis of diachronic sociolinguistic data.
		\end{innerlist}
	...
	\textit{National Science Foundation Graduate Research Fellow}
	\hfill{\bf{2018 - 2023}}
