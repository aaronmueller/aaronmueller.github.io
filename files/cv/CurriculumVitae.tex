...
\begin{document}
	...
	\item \textbf{Aaron Mueller}, Albert Webson, Jackson Petty, Tal Linzen. ``In-context Learning Generalizes, But Not Always Robustly: The Case of Syntax.'' In submission to \emph{International Conference on Learning Representations (ICLR)}, 2023.
...
%	\hfill 2014
	...
	\begin{innerlist}
	\item Dan Pechi (New York University). In progress. Research on imparting\hfill 2023--Present\\inductive biases to language models.
	\item Swapnil Sharma (New York University). In progress. Research on evaluating\hfill 2022--Present\\summarization models.
